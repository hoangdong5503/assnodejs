                    ...
                    <div className="col-md-6">
                      ...
                      <div className="more-info">
                        ...
                        <ul className="list-ico">
                          ...
                          <li>
                            <span className="bi bi-phone"></span> 0000-0000-0000
                          </li>
                          <li>
                            <span className="bi bi-envelope"></span>{" "}
                            Dong552003@gmail.com
                          </li>
                        </ul>
                      </div>
                      <div className="socials">
                        <ul>
                          <li>
                            <a href="https://www.facebook.com/profile.php?id=100013424738388">
                          ...
                          <li>
                            <a href="https://www.instagram.com/en_gnod/">
                              <span className="ico-circle">
